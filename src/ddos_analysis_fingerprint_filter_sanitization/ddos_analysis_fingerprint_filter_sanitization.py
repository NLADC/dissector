...
get_ipython().magic('run functions/protocolnumber2name.ipynb')
...
get_ipython().magic('run functions/portnumber2name.ipynb')
...
get_ipython().magic('run functions/tcpflagletters2names.ipynb')
...
get_ipython().magic('run functions/check_filetype.ipynb')
...
get_ipython().magic('run functions/pcap2dataframe.ipynb')
get_ipython().magic('run functions/pcapng2dataframe.ipynb')
get_ipython().magic('run functions/sflow2dataframe.ipynb')
...
#             if debug: print(ips_ttl_greater_4)
            ...
            if (percent_src_ports.values[0] == 100):
                ...
                if (len(percent_src_ports) == 1):
                    ...
                    # if debug: print("\nCASE 1: 1 source port to 1 destination port") if debug else next
                    port_label = "Using " + get_port_name(percent_src_ports.keys()[0]) + "[" + '%.1f' %                                                                                                                   percent_src_ports.values[
                                                                                                                      0] + "%]" + "\n   - Against " + get_port_name(
                        percent_dst_ports.keys()[0]) + "[" + '%.1f' % percent_dst_ports.values[0] + "%]"
